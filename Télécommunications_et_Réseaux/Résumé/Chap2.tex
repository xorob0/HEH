...
\label{fig:exemplesPileProtocoles}
 ...
 \begin{figure}[h]
	 \centering
	 \includegraphics[height=5cm]{OSI}
	 \caption{Modèle OSI}
 \end{figure}
 \begin{numbering}
